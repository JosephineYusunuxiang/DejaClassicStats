...
-- Ranged Damage
local function RangedDamage() --远程攻强，UnitRangedDamage()API在1.14已失效
...
-- Bonus Melee Hit Chance Modifier--近战命中率，GetHitModifier()API在1.14已失效
local function HitModifier()
	local hit = GetHitModifier()
	if hit == nil then hit = 0 end
	return "", format("%.2f%%", hit), "", "", "", ""
end
-- Bonus Ranged Hit Chance Modifier--远程命中率，GetHitModifier()API在1.14已失效
...
-- Bonus Spell Hit Chance Modifier --法术命中率，GetSpellHitModifier()API在1.14已失效
...
-- Bonus Healing
local function PlusHealing() --治疗强度，GetSpellBonusHealing()API在1.14已失效
